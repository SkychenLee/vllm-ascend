...
class PunicaWrapperNPU(PunicaWrapperBase):
    ...
    def update_metadata(
        ...
        **kwargs,
        ...
        # PunicaWrapperBase refreshes no_lora only for prefill metadata.
        # Keep it batch-accurate for decode too so base-only batches retain
        # the original fused W8A8 MoE path.
